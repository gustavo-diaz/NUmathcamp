...
The area   is 1/3, we will do this together when we meet, but the essence of the answer is drawing the function and then calculating the area of a rectangle.
...
**Definite integrals** instead return a value that represents the area under a curve, which means we need to specify a range to evaluate the area in question.
