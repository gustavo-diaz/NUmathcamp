...
<RonaldoMonasterio2028@u.northwestern.edu>
:::
...
schedule =
  tribble(
    ...
    1, "Thursday, September 10", "Notation, sets, functions", "Tidyverse I",
    1, "Friday, September 11", "Matrices", "Tidyverse II",
    2, "Monday, September 14", "Calculus I", "Sampling and simulation",
    2, "Tuesday, September 15", "Calculus II", "Markdown I",
    2, "Wednesday, September 16", "Markdown II", "NO MEETING",
    2, "Thursday, September 17", "GitHub", "NO MEETING ",
    2, "Friday, September 18", "Review", "NO MEETING"
)
```
...
::: incremental
- Class is not graded, but you can get credit for attending (POLI_SCI 490)
...
Schedule a meeting if you want to chat: [cal.com/gustavodiaz](https://cal.com/gustavodiaz/)

![](img/cal.png){fig-align="right" width="250" height="250"}
