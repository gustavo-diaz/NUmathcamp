...
There are different `geoms` available! Take a look on it in the [CheatSheet](https://posit.co/wp-content/uploads/2022/10/data-visualization-1.pdf). Throughout today we'll be using `ggplot()` a lot!
